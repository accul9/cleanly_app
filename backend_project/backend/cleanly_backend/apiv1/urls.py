...
from .views import TaskViewSet, UserViewSet, LoginAPIView, LogoutAPIView, CsrfTokenAPIView, AuthCheckAPIView
...
urlpatterns = [
    ...
    path('check_auth/', AuthCheckAPIView.as_view(), name='check_auth')
]